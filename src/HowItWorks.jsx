    ...
    return (
        <section id="features" className="py-16 bg-background">
            <div className="max-w-6xl mx-auto text-center">
                ...
                <h3 className="text-gray-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis temporibus minus, magni voluptate accusamus doloremque consequuntur itaque doloribus? Sint officiis similique veritatis cum magni voluptas quasi voluptatem ducimus tempora assumenda?</h3>
